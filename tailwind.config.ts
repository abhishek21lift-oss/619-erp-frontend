...
const config: Config = {
  ...
  safelist: [
    ...
    'shadow-[0_8px_32px_-8px_rgba(6,182,212,0.45)]',
    ...
    'bg-white/25', 'bg-white/15', 'bg-white/30', 'bg-white/40',
    'bg-white/50', 'bg-white/60', 'bg-white/70', 'bg-white/75',
    'bg-white/80', 'bg-white/85', 'bg-white/90',
    'backdrop-blur-md',
