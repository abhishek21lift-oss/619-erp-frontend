...
interface NutritionProgressTimelineProps {
  current: StepId;
  onStep: (s: StepId) => void;
}

export function NutritionProgressTimeline({ current, onStep }: NutritionProgressTimelineProps) {
  return (
...
export default NutritionProgressTimeline;
