...
interface MobilityProgressTimelineProps {
  current: StepId;
  onStep: (s: StepId) => void;
}

export function MobilityProgressTimeline({ current, onStep }: MobilityProgressTimelineProps) {
  return (
...
export default MobilityProgressTimeline;
