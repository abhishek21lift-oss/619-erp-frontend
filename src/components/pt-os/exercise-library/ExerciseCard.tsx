            ...
            <div className="relative" ref={menuRef}>
              ...
              {menuOpen && (
                <div
                  ...
                  className="absolute right-0 top-full z-30 mt-1 w-44 overflow-hidden rounded-xl border border-slate-200 bg-white py-1 shadow-xl dark:border-white/10 dark:bg-[#151519]"
                >
