  ...
  return (
    <div style={{ borderRadius: 20, background: 'rgba(255,255,255,0.72)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.6)', boxShadow: '0 4px 24px rgba(0,0,0,0.06)', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '18px 22px', borderBottom: '1px solid rgba(226,232,240,0.6)', display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div>
          <div style={{ fontSize: 15, fontWeight: 700, color: '#0f172a' }}>Face Enrollment</div>
          <div style={{ fontSize: 12, color: '#94a3b8' }}>Register your face for camera check-in</div>
        </div>
        {step === 'success' && (
      ...
      <div style={{ padding: 22 }}>
        ...
        {step === 'starting' && (
          <div style={{ textAlign: 'center', padding: '32px 0' }}>
            ...
            <p style={{ fontSize: 13, color: '#64748b' }}>Starting camera &amp; loading AI models…</p>
          </div>
        )}
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: 10, marginTop: 14 }}>
              <button
                ...
                style={{ flex: '0 0 auto', padding: '9px 14px', borderRadius: 10, border: '1px solid rgba(226,232,240,0.7)', background: 'rgba(248,250,252,0.8)', color: '#64748b', fontSize: 12, fontWeight: 600, cursor: 'pointer' }}
              >
                Cancel
              </button>
              <button
                ...
                style={{
                  ...
                  color: hasFace && step !== 'saving' ? '#fff' : '#94a3b8',
        ...
        {step === 'success' && (
          <div style={{ textAlign: 'center', padding: '24px 0' }}>
            ...
            <p style={{ fontSize: 12, color: '#64748b', marginBottom: 20 }}>They can now check in using the face recognition camera.</p>
            <button
              onClick={reset}
        ...
        {step === 'error' && (
          <div style={{ textAlign: 'center', padding: '24px 0' }}>
            ...
            <p style={{ fontSize: 13, color: '#64748b', marginBottom: 18 }}>{message}</p>
            <button
              onClick={reset}
