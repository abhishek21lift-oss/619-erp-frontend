...
const MORE_ROUTES = ['/member/more', '/member/messages', '/member/card', '/member/records', '/member/goals', '/member/recap', '/member/renew', '/member/progress', '/member/photos', '/member/notifications', '/member/forms', '/member/account'];
