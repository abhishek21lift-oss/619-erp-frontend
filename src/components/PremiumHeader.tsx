  ...
  },
  {
    ...
    columns: [
      ...
      { heading: 'PT Programs', items: [
        ...
        { label: 'Schedule Session', href: '/pt-os/schedule-session', description: 'Book a session' },
              ...
              {col.items.map((item) => {
                            ...
                            {item.children.map((child) => {
                              ...
                              return (
                                <button
                                  ...
                                  style={ca ? { background: 'rgba(0,0,0,0.04)' } : {}}
                                >
                ...
                return (
                  <button
                    ...
                    style={ia ? { background: 'rgba(0,0,0,0.04)' } : {}}
                  >
                    <div className="min-w-0 flex-1">
...
function AccountMenuPortal({
  ...
  return createPortal(
    ...
    >
      ...
      <div className="my-1 h-px" style={{ background: 'rgba(0,0,0,0.04)' }} />
