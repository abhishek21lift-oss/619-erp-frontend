      ...
      >
        ...
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <p className="mt-1.5 text-[14px]" style={{ color: MUTE }}>
            {copy.blurb}{lastOrg ? <> · <span className="font-[650]" style={{ color: MAROON }}>{lastOrg}</span></> : ''}
          </p>
        </div>
        ...
        >
            ...
            <AnimatePresence>
              {error && (
                ...
                >
                  ...
                  <span className="text-[13px] font-[550]" style={{ color: '#B91C1C', lineHeight: 1.4 }}>
                    {error}
                    {wrongPortal && (
                      <>
                        {' '}
          ...
          <div className="mt-5 text-center">
            <Link
              href={copy.otherHref}
              className="inline-flex items-center gap-1.5 rounded-full px-4 py-2 text-[12.5px] font-[650] transition-colors hover:bg-black/[0.04]"
              style={{ color: MUTE }}
            >
              {copy.otherLabel}
              <ArrowRight size={13} />
