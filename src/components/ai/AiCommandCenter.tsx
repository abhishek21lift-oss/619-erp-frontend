                  ...
                  <div className="grid grid-cols-2 gap-1.5">
                    {actions.map((a) => (
                      <button key={a.id} type="button" onClick={() => runAction(a)}
                        className="flex items-center gap-2 rounded-[13px] px-2.5 py-2.5 text-left transition-transform active:scale-[0.98]"
