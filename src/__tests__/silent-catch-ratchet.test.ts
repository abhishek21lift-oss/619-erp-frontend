...
const KNOWN = [
  ...
  'app/(chrome)/ai-coach/knowledge/page.tsx:73',
  ...
  'app/(chrome)/pt-os/diet-plans/page.tsx:196',
  ...
  'app/(chrome)/settings/profile/page.tsx:1610',
  'app/(chrome)/settings/profile/page.tsx:1883',
  'app/(chrome)/settings/profile/page.tsx:820',
  'app/(chrome)/settings/profile/page.tsx:821',
  ...
  'app/(platform)/platform/_tabs/StudiosTab.tsx:374',
