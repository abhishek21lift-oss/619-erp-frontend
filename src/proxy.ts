 ...
 *   /_next/*, /api/*, /models/*, /face-models/*, favicon, images, fonts
 */
...
export const config = {
  matcher: [
    '/((?!api|_next/static|_next/image|favicon\.ico|models|face-models|.*\.(?:png|jpg|jpeg|gif|svg|ico|webp|avif|woff2|woff|ttf|otf)).*)',
  ],
};
