              ...
              <div className="flex flex-wrap gap-2">
                {PERIODS.map((p) => (
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${period === p.value ? 'bg-primary text-primary-foreground' : 'border border-gray-200 text-gray-600 hover:bg-gray-50'}`}
                  >
                    {p.label}
                  </button>
                ))}
