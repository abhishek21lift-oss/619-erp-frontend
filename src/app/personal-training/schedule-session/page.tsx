        ...
        <div className="mx-auto max-w-screen-xl px-5 py-4 sm:px-8">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3">
            <div className="inline-flex overflow-hidden rounded-[12px] p-0.5"
              style={{ background: 'rgba(255,255,255,0.80)', border: '1px solid rgba(15,23,42,0.08)', boxShadow: '0 1px 4px rgba(15,23,42,0.04)' }}>
              {([
      ...
      {step === 1 ? (
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              {(['1-on-1', 'Group', 'Assessment'] as const).map((t) => (
                <button key={t} type="button" onClick={() => setForm((f) => ({ ...f, type: t }))}
                  ...
                  style={{
                    background: form.type === t ? 'rgba(220,38,38,0.10)' : 'rgba(248,250,252,0.9)',
          ...
          <div>
            ...
            <textarea value={form.notes} onChange={(e) => setForm((f) => ({ ...f, notes: e.target.value }))}
              ...
              style={{ background: 'rgba(248,250,252,0.9)', border: '1.5px solid rgba(15,23,42,0.09)', color: 'rgb(15,23,42)', minHeight: 60 }}
            />
          </div>
          ...
          <button type="button" onClick={() => setForm((f) => ({ ...f, recurring: !f.recurring }))}
            ...
            style={{
              background: form.recurring ? 'rgba(220,38,38,0.08)' : 'rgba(248,250,252,0.9)',
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={item.k} className="flex justify-between py-1.5 border-b" style={{ borderColor: 'rgba(15,23,42,0.06)' }}>
      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            <div key={item.label} className="rounded-[10px] p-3" style={{ background: 'rgba(248,250,252,0.8)' }}>
        ...
        {/* Notes */}
        {session.notes && (
          <div className="rounded-[12px] p-3.5" style={{ background: 'rgba(248,250,252,0.8)', border: '1px solid rgba(15,23,42,0.06)' }}>
