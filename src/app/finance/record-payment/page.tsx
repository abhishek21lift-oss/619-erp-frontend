...
import {
  ...
  PenSquare, ArrowRight, Calendar, User, Building,
                ...
                <motion.div key="form" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="space-y-5">
                  ...
                  <SectionCard icon={<Receipt className="h-4 w-4" />} title="Link Invoice" subtitle="Associate payment with an existing invoice">
                    <button
                      ...
                      style={{
                        background: selectedInvoice ? 'rgba(255,255,255,0.95)' : 'rgba(248,250,252,0.9)',
                        border: selectedInvoice ? '1.5px solid rgba(99,102,241,0.40)' : '1.5px solid rgba(15,23,42,0.09)',
                      }}
                    >
                      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-[9px]" style={{ background: selectedInvoice ? 'rgba(99,102,241,0.08)' : 'rgba(15,23,42,0.05)' }}>
                      ...
                      {PAYMENT_METHODS.map((method) => {
                        ...
                        return (
                          <motion.button
                            ...
                            style={{
                              background: active ? method.bg : 'rgba(255,255,255,0.80)',
                          ...
                          >
                            <div className="flex h-11 w-11 items-center justify-center rounded-[12px] transition-all"
                              style={{ background: active ? method.color : 'rgba(15,23,42,0.05)', color: active ? 'white' : 'rgb(148,163,184)' }}>
                              {method.icon}
                            </div>
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      {[5000, 10000, 17500, 28500, 45000].map((val) => (
                        <motion.button
                          ...
                          style={{
                            background: amount === val.toString() ? 'rgba(220,38,38,0.08)' : 'rgba(255,255,255,0.80)',
                            borderColor: amount === val.toString() ? 'rgba(220,38,38,0.25)' : 'rgba(15,23,42,0.07)',
              ...
              {invoices.map((inv) => (
                <motion.button
                  ...
                  style={{
                    ...
                    borderColor: selectedInvoice?.id === inv.id ? 'rgba(99,102,241,0.25)' : 'rgba(15,23,42,0.06)',
                  }}
                >
                  <div>
