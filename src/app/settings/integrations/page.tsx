...
const INTEGRATIONS: Integration[] = [
  { id: 'razorpay', name: 'Razorpay', description: 'Payment gateway for membership fees and PT sessions', category: 'payments', icon: <CreditCard size={16} />, color: '#7c3aed', bg: 'rgba(124,58,237,0.08)', status: 'connected', connectedAt: '12 Mar 2026', lastSync: '2 mins ago', popular: true },
  { id: 'stripe', name: 'Stripe', description: 'Global payment processing with auto-reconciliation', category: 'payments', icon: <CreditCard size={16} />, color: '#6366f1', bg: 'rgba(99,102,241,0.08)', status: 'connected', connectedAt: '5 Jan 2026', lastSync: '5 mins ago', popular: true },
  { id: 'phonepe', name: 'PhonePe', description: 'UPI-based instant payment collection', category: 'payments', icon: <CreditCard size={16} />, color: '#0d9488', bg: 'rgba(13,148,136,0.08)', status: 'connected', connectedAt: '20 Feb 2026', lastSync: '1 hr ago' },
  { id: 'paytm', name: 'Paytm', description: 'All-in-one payment solutions for businesses', category: 'payments', icon: <CreditCard size={16} />, color: '#2563eb', bg: 'rgba(37,99,235,0.08)', status: 'pending' },
  { id: 'whatsapp', name: 'WhatsApp Business', description: 'Automated reminders, invoices & engagement', category: 'communication', icon: <MessageSquare size={16} />, color: '#10b981', bg: 'rgba(16,185,129,0.08)', status: 'connected', connectedAt: '8 Apr 2026', lastSync: 'Just now', popular: true },
  { id: 'twilio', name: 'Twilio SMS', description: 'SMS notifications for check-ins and renewals', category: 'communication', icon: <MessageSquare size={16} />, color: '#f43f5e', bg: 'rgba(244,63,94,0.08)', status: 'connected', connectedAt: '15 Mar 2026', lastSync: '10 mins ago' },
  { id: 'gmail', name: 'Gmail SMTP', description: 'Send transactional emails via Gmail', category: 'communication', icon: <Globe size={16} />, color: '#ea4335', bg: 'rgba(234,67,53,0.08)', status: 'connected', connectedAt: '1 Jan 2026', lastSync: '30 mins ago' },
  { id: 'sms', name: 'SMS Gateway', description: 'Bulk SMS for campaign broadcasts', category: 'communication', icon: <MessageSquare size={16} />, color: '#f59e0b', bg: 'rgba(245,158,11,0.08)', status: 'pending' },
  { id: 'openai', name: 'OpenAI', description: 'AI-powered insights, recommendations & chat', category: 'ai', icon: <Brain size={16} />, color: '#10a37f', bg: 'rgba(16,163,127,0.08)', status: 'connected', connectedAt: '22 Apr 2026', lastSync: '1 min ago', popular: true },
  { id: 'claude', name: 'Claude AI', description: 'Advanced AI for member engagement analysis', category: 'ai', icon: <Brain size={16} />, color: '#8b5cf6', bg: 'rgba(139,92,246,0.08)', status: 'pending', comingSoon: true },
  { id: 'zapier', name: 'Zapier', description: 'Connect 5000+ apps with automated workflows', category: 'ai', icon: <Zap size={16} />, color: '#ff4a00', bg: 'rgba(255,74,0,0.08)', status: 'connected', connectedAt: '3 May 2026', lastSync: '15 mins ago' },
  { id: 'make', name: 'Make (Integromat)', description: 'Visual automation scenarios for gym ops', category: 'ai', icon: <Radio size={16} />, color: '#6d28d9', bg: 'rgba(109,40,217,0.08)', status: 'pending', comingSoon: true },
  { id: 'google-cal', name: 'Google Calendar', description: 'Two-way sync for PT sessions & classes', category: 'scheduling', icon: <Calendar size={16} />, color: '#4285f4', bg: 'rgba(66,133,244,0.08)', status: 'connected', connectedAt: '10 Jan 2026', lastSync: 'Just now', popular: true },
  { id: 'calendly', name: 'Calendly', description: 'Automated booking for trial sessions', category: 'scheduling', icon: <Calendar size={16} />, color: '#006bff', bg: 'rgba(0,107,255,0.08)', status: 'error' },
  { id: 'zoom', name: 'Zoom', description: 'Virtual PT sessions and team meetings', category: 'scheduling', icon: <Camera size={16} />, color: '#0b5cff', bg: 'rgba(11,92,255,0.08)', status: 'pending' },
  { id: 'face-recog', name: 'Face Recognition', description: 'AI-powered biometric check-in system', category: 'devices', icon: <Camera size={16} />, color: '#dc2626', bg: 'rgba(220,38,38,0.08)', status: 'connected', connectedAt: '15 Jan 2026', lastSync: 'Just now', popular: true },
  { id: 'qr-scanner', name: 'QR Code Scanner', description: 'Quick check-in via member QR codes', category: 'devices', icon: <Smartphone size={16} />, color: '#0891b2', bg: 'rgba(8,145,178,0.08)', status: 'connected', connectedAt: '20 Feb 2026', lastSync: '5 mins ago' },
  { id: 'smart-gates', name: 'Smart Turnstile Gates', description: 'Hardware integration for entry control', category: 'devices', icon: <Wifi size={16} />, color: '#475569', bg: 'rgba(71,85,105,0.08)', status: 'error' },
  { id: 'biometric', name: 'Biometric Scanner', description: 'Fingerprint + RFID access system', category: 'devices', icon: <Cpu size={16} />, color: '#7c3aed', bg: 'rgba(124,58,237,0.08)', status: 'pending' },
  { id: 'ga', name: 'Google Analytics', description: 'Website traffic and conversion tracking', category: 'analytics', icon: <BarChart3 size={16} />, color: '#e37400', bg: 'rgba(227,116,0,0.08)', status: 'connected', connectedAt: '1 Jan 2026', lastSync: '1 hr ago' },
  { id: 'meta-pixel', name: 'Meta Pixel', description: 'Facebook/Instagram ad conversion tracking', category: 'analytics', icon: <BarChart3 size={16} />, color: '#0866ff', bg: 'rgba(8,102,255,0.08)', status: 'pending' },
];
