...
import { Plus, Search, Phone, Mail, Calendar, ChevronRight, Sparkles, Users, RefreshCw, UserCheck, Clock } from 'lucide-react';
...
function Inner() {
  ...
  const load = () => {
    ...
    api.clients.list({}).then(r => {
      const leads = r.filter(c => c.status === 'lead' || !c.pt_end_date);
      setEnquiries(leads);
      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-6 sm:px-6 lg:px-8">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => router.push('/sales/enquiry')}
                ...
                {filtered.map((enq, i) => {
                  ...
                  return (
                    <motion.tr
                      ...
                      className="group cursor-pointer border-b border-slate-100/60 transition hover:bg-slate-50/80"
