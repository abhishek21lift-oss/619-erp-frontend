        ...
        <div className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 sm:py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="rounded-[20px] p-6" style={{ background: 'var(--bg-card)', border: '1px solid var(--border)' }}>
              <h2 className="text-[18px] font-[760] mb-5" style={{ color: 'var(--text-primary)' }}>Log Lift</h2>
            ...
            <div className="rounded-[20px] p-6" style={{ background: 'var(--bg-card)', border: '1px solid var(--border)' }}>
              <h2 className="text-[18px] font-[760] mb-5" style={{ color: 'var(--text-primary)' }}>Lift History</h2>
              <div className="space-y-2 max-h-[500px] overflow-y-auto">
                {(logs.data as any[] || []).map((l: any) => (
                  <div key={l.id} className="rounded-[12px] p-3" style={{ background: 'var(--bg-subtle)', border: '1px solid var(--border)' }}>
                    <div className="flex items-center justify-between">
                      <span className="text-[13px] font-[700]" style={{ color: 'var(--text-primary)' }}>{l.exercise_name}</span>
                      <span className="text-[11px]" style={{ color: 'var(--text-muted)' }}>{l.log_date}</span>
                    </div>
                ...
                {(!logs.data || (logs.data as any[]).length === 0) && (
                  <p className="text-center py-8 text-sm" style={{ color: 'var(--text-muted)' }}>No lifts logged yet.</p>
                )}
              </div>
            </div>
          </div>
