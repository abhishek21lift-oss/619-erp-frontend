    ...
    <Guard>
      <AppShell>
        <div className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 sm:py-8">
          ...
          >
            {/* Summary bar */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-px" style={{ background: 'rgba(0,0,0,0.04)' }}>
              {[
            ...
            {/* Filters */}
            <div className="flex items-center gap-3 p-4 border-b" style={{ borderColor: 'rgba(0,0,0,0.04)' }}>
              <div className="relative flex-1 max-w-xs">
                ...
                <input
                  ...
                  onBlur={(e) => { e.currentTarget.style.borderColor = 'rgba(0,0,0,0.06)'; e.currentTarget.style.boxShadow = ''; }}
                />
              </div>
