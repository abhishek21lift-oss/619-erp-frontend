      ...
      <AppShell>
        <div className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 sm:py-8">
          ...
          <div className="mb-6 flex items-center justify-between">
            <div>
              <h1 className="text-[22px] font-extrabold tracking-[-0.02em] text-[#0B0B0F]">
                Session History
              </h1>
          ...
          <div className="mb-5 flex flex-wrap items-center gap-3">
            <div className="relative flex-1 min-w-[200px] max-w-[360px]">
              ...
              <input
                ...
                className="w-full h-10 rounded-xl border border-[rgba(0,0,0,0.06)] bg-white pl-9 pr-4 text-[13px] text-[#0B0B0F] placeholder-[#9CA3AF] outline-none transition-all duration-200 focus:border-[#3B82F6]/30 focus:shadow-[0_0_0_3px_rgba(59,130,246,0.06)]"
              />
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="truncate text-[14px] font-semibold text-[#0B0B0F]">
