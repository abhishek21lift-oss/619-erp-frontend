...
// Error boundary for /help (audit H-02).
//
// Without this, a throw anywhere under /help propagated to src/app/error.tsx
...
export default function HelpError(
  ...
  return <RouteError {...props} shell={false} segment="help" />;
}
