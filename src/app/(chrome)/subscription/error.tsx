...
// Error boundary for /subscription (audit H-02).
//
// Without this, a throw anywhere under /subscription propagated to src/app/error.tsx
...
export default function SubscriptionError(
  ...
  return <RouteError {...props} shell={false} segment="subscription" />;
}
