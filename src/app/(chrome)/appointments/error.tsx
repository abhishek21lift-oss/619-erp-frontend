...
// Error boundary for /appointments (audit H-02).
//
// Without this, a throw anywhere under /appointments propagated to src/app/error.tsx
...
export default function AppointmentsError(
  ...
  return <RouteError {...props} shell={false} segment="appointments" />;
}
