...
// Error boundary for /reports (audit H-02).
//
// Without this, a throw anywhere under /reports propagated to src/app/error.tsx
...
export default function ReportsError(
  ...
  return <RouteError {...props} shell={false} segment="reports" />;
}
