...
// Error boundary for /insights (audit H-02).
//
// Without this, a throw anywhere under /insights propagated to src/app/error.tsx
...
export default function InsightsError(
  ...
  return <RouteError {...props} shell={false} segment="insights" />;
}
