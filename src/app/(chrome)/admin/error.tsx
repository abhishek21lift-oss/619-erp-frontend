...
// Error boundary for /admin (audit H-02).
//
// Without this, a throw anywhere under /admin propagated to src/app/error.tsx
...
export default function AdminError(
  ...
  return <RouteError {...props} shell={false} segment="admin" />;
}
