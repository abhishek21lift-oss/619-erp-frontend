...
// Error boundary for /ai-coach (audit H-02).
//
// Without this, a throw anywhere under /ai-coach propagated to src/app/error.tsx
...
export default function AiCoachError(
  ...
  return <RouteError {...props} shell={false} segment="ai-coach" />;
}
