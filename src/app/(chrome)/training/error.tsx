...
// Error boundary for /training (audit H-02).
//
// Without this, a throw anywhere under /training propagated to src/app/error.tsx
...
export default function TrainingError(
  ...
  return <RouteError {...props} shell={false} segment="training" />;
}
