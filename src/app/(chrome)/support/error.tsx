...
// Error boundary for /support (audit H-02).
//
// Without this, a throw anywhere under /support propagated to src/app/error.tsx
...
export default function SupportError(
  ...
  return <RouteError {...props} shell={false} segment="support" />;
}
