...
// Error boundary for /trainers (audit H-02).
//
// Without this, a throw anywhere under /trainers propagated to src/app/error.tsx
...
export default function TrainersError(
  ...
  return <RouteError {...props} shell={false} segment="trainers" />;
}
