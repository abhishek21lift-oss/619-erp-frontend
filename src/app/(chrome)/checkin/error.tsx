...
// Error boundary for /checkin (audit H-02).
//
// Without this, a throw anywhere under /checkin propagated to src/app/error.tsx
...
export default function CheckinError(
  ...
  return <RouteError {...props} shell={false} segment="checkin" />;
}
