...
// Error boundary for /pay (audit H-02).
//
// Without this, a throw anywhere under /pay propagated to src/app/error.tsx
...
export default function PayError(
  ...
  return <RouteError {...props} shell={false} segment="pay" />;
}
