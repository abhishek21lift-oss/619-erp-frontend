...
// Error boundary for /attendance (audit H-02).
//
// Without this, a throw anywhere under /attendance propagated to src/app/error.tsx
...
export default function AttendanceError(
  ...
  return <RouteError {...props} shell={false} segment="attendance" />;
}
