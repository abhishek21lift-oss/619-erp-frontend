...
// Error boundary for /sales (audit H-02).
//
// Without this, a throw anywhere under /sales propagated to src/app/error.tsx
...
export default function SalesError(
  ...
  return <RouteError {...props} shell={false} segment="sales" />;
}
