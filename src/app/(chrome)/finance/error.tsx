...
// Error boundary for /finance (audit H-02).
//
// Without this, a throw anywhere under /finance propagated to src/app/error.tsx
...
export default function FinanceError(
  ...
  return <RouteError {...props} shell={false} segment="finance" />;
}
