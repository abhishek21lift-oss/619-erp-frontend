...
// Error boundary for /settings (audit H-02).
//
// Without this, a throw anywhere under /settings propagated to src/app/error.tsx
...
export default function SettingsError(
  ...
  return <RouteError {...props} shell={false} segment="settings" />;
}
