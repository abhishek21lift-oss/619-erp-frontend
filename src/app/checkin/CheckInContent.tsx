...
export default function CheckInContent() {
  ...
  useEffect(() => {
    try {
      const s = localStorage.getItem('619_checkins_today');
        ...
        <div className="page-header-row">
          ...
          <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
            ...
            <span className="badge badge-neutral">
              <Clock size={10} style={{ marginRight: 4 }} />{recents.length} today
            </span>
          </div>
        </div>
      </div>
          ...
          <div className="camera-wrap">
            ...
            <div className="camera-overlay" style={{
              background: isSuccess
                ? 'rgba(34,197,94,0.15)'
                : isError ? 'rgba(239,68,68,0.15)' : 'transparent',
            }} />
            ...
            <div className="camera-pill" style={{ color: sc.color }}>
              ...
              <StatusIcon
                size={12}
                style={isSpinning ? { animation: 'spin 0.9s linear infinite' } : {}}
              />
              <span>{sc.label}</span>
            </div>
          </div>
            ...
            <div
              ...
              style={{
                ...
                borderBottom: `1px solid ${
                  isSuccess ? 'var(--success-border)' : 'var(--danger-border)'
                }`,
            ...
            <div className="card-header" style={{ padding: '12px 16px' }}>
              ...
              {recents.length > 0 && (
                <button
                  ...
                  onClick={() => {
                    setRecents([]);
                    try { localStorage.removeItem('619_checkins_today'); } catch {}
                  }}
                >
                  Clear
                </button>
              ...
              {recents.length === 0 ? (
                ...
                recents.map((r) => (
                  ...
                  >
                    ...
                    <span className={
                      r.status === 'success' ? 'badge badge-active' :
                      r.status === 'failed'  ? 'badge badge-expired' :
                      'badge badge-neutral'
                    }>
                      {r.status}
                    </span>
