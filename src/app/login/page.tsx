    ...
    <div className="min-h-screen bg-[#f0efed] flex overflow-hidden relative font-['Inter',sans-serif]">
      ...
      <div className="relative z-10 flex w-full items-center justify-center p-6">
        ...
        >
          ...
          {/* ── Login Card ── */}
          <div className="relative bg-white rounded-[20px] border border-[#DC2626]/20 shadow-[0_8px_40px_rgba(0,0,0,0.08),0_2px_8px_rgba(220,38,38,0.06)] overflow-hidden">
            ...
            <div className="px-8 py-10 sm:px-10 sm:py-12">
              ...
              <div className="flex flex-col items-center mb-8">
                ...
                <motion.h1
                  ...
                  className="text-[22px] font-bold text-[#1A1A1A] tracking-[0.15em] uppercase"
                >
                  619 FITNESS{' '}
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="w-full h-[50px] pl-4 pr-11 rounded-[12px] bg-[#F9F9F9] border border-[#E5E5E5] text-[14px] text-[#1A1A1A] outline-none transition-all duration-200 placeholder:text-[#9CA3AF]/70 focus:border-[#DC2626]/40 focus:bg-white focus:shadow-[0_0_0_3px_rgba(220,38,38,0.06)]"
                    />
          ...
          >
            <p className="text-[11px] text-[#9CA3AF] tracking-[0.03em]">
