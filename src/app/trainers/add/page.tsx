...
export default function AddCoachPage() {
            ...
            {DAYS.map(function(d) {
              ...
              return (
                <button key={d} type="button"
                  ...
                  style={{ background: on ? '#10b981' : 'rgba(15,23,42,0.04)', color: on ? '#fff' : 'rgb(100,116,139)', border: on ? '1.5px solid #10b981' : '1.5px solid transparent', boxShadow: on ? '0 2px 8px rgba(16,185,129,0.25)' : 'none' }}>
                  {d}
                </button>
              );
            })}
  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg,#f8fafc 0%,#f1f5f9 50%,#f8f4ff 100%)' }}>
      <div className="sticky top-0 z-30 border-b" style={{ background: 'rgba(255,255,255,0.82)', backdropFilter: 'blur(20px)', borderColor: 'rgba(15,23,42,0.07)' }}>
      ...
      <div className="mx-auto max-w-3xl px-5 py-8">
        ...
        <AnimatePresence mode="wait">
          <motion.div key={step}
            ...
            style={{ background: 'rgba(255,255,255,0.92)', border: '1px solid rgba(255,255,255,0.95)', boxShadow: '0 4px 24px rgba(15,23,42,0.07), 0 1px 3px rgba(15,23,42,0.04)', backdropFilter: 'blur(20px)' }}>
