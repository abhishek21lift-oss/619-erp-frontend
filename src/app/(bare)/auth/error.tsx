...
// Error boundary for /auth (audit H-02).
//
// Without this, a throw anywhere under /auth propagated to src/app/error.tsx
...
export default function AuthError(
  ...
  return <RouteError {...props} shell={false} segment="auth" />;
}
