    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1, display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ fontSize: 11, color: 'var(--text-muted)', marginTop: 2, fontWeight: 600, letterSpacing: '0.01em', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
            {cfg.label}
          </div>
        </div>
      ...
      {cfg.sub && (
        <div style={{
          ...
          fontSize: 10, color: 'var(--text-disabled)', marginTop: 8, fontWeight: 500,
          paddingLeft: 48,
        }}>
          {cfg.sub}
        </div>
            ...
            return (
              <div key={group}>
                ...
                {items.map((item) => (
                  ...
                  >
                    <span style={{ color: 'var(--text-disabled)' }}>{item.icon}</span>
                    {item.label}
                  </button>
                ))}
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    border: '1px solid rgba(0,0,0,0.1)', background: 'var(--bg-white)',
                ...
                <Link
                  ...
                  style={{
                    ...
                    background: 'linear-gradient(135deg, #6366f1, #8b5cf6)',
                    color: 'var(--bg-white)', fontSize: 13, fontWeight: 600,
            ...
            <div style={{
              ...
              <div style={{
                ...
                <Search size={14} style={{
                  position: 'absolute', left: 12, color: searchFocused ? '#6366f1' : 'var(--text-disabled)',
                ...
                {search && (
                  <button
                    ...
                    style={{
                      ...
                      border: 'none', cursor: 'pointer', color: 'var(--text-disabled)', padding: 2,
                      display: 'flex', alignItems: 'center',
                    }}
                  >
                    <X size={12} />
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        background: isActive ? 'rgba(99,102,241,0.1)' : 'var(--bg-subtle)',
                        color: isActive ? '#6366f1' : 'var(--text-muted)',
                        fontSize: 12, fontWeight: isActive ? 600 : 500, cursor: 'pointer',
                        transition: 'all 0.15s ease',
                      }}
                    >
                      <span style={{ color: isActive ? '#6366f1' : 'var(--text-disabled)' }}>{s.icon}</span>
                      {s.label}
                      {count > 0 && (
                        <span style={{
                          background: isActive ? '#6366f1' : 'var(--border-3)',
              ...
              {/* Results count */}
              {debouncedSearch && (
                <span style={{ fontSize: 12, color: 'var(--text-disabled)', marginLeft: 'auto', whiteSpace: 'nowrap' }}>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', tableLayout: 'auto' }}>
                  <thead>
                    <tr style={{ borderBottom: '1px solid rgba(0,0,0,0.06)' }}>
                      ...
                      <th style={{ padding: '12px 16px', textAlign: 'left', background: '#f8fafc' }}>
                        <span style={{ fontSize: 11, fontWeight: 600, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>Plan</span>
                      </th>
                      <th style={{ padding: '12px 16px', textAlign: 'left', background: '#f8fafc' }}>
                      ...
                      paginated.map((c) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td style={{ padding: '13px 16px' }}>
                              <div style={{ display: 'flex', alignItems: 'center', gap: 11 }}>
                                <div style={{
                                  ...
                                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                                  fontSize: 13, fontWeight: 700, color: 'var(--bg-white)',
                                ...
                                <div style={{ minWidth: 0 }}>
                                  ...
                                  <div style={{
                                    fontSize: 11, color: 'var(--text-disabled)', marginTop: 1,
                                    whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis',
                                  }}>
                                    {c.phone ? (
                                      <a
                            ...
                            {/* Joined */}
                            <td style={{ padding: '13px 16px' }}>
                              <span style={{ fontSize: 12, color: 'var(--text-disabled)' }}>{fmtDate(c.joining_date)}</span>
                            </td>
              ...
              {!loading && filtered.length > PAGE_SIZE && (
                <div style={{
                  ...
                  <span style={{ fontSize: 12, color: 'var(--text-disabled)' }}>
                    Showing {((page - 1) * PAGE_SIZE) + 1}–{Math.min(page * PAGE_SIZE, filtered.length)} of <strong style={{ color: 'var(--text-muted)' }}>{filtered.length}</strong>
                  </span>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                    <button
                      ...
                      style={{
                        ...
                        background: page <= 1 ? '#f8fafc' : 'var(--bg-white)', cursor: page <= 1 ? 'default' : 'pointer',
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                    ...
                    <button
                      ...
                      style={{
                        width: 30, height: 30, borderRadius: 7, border: '1px solid rgba(0,0,0,0.08)',
                        background: page >= totalPages ? '#f8fafc' : 'var(--bg-white)',
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', marginTop: 12 }}>
                <button
                  ...
                  style={{
                    ...
                    border: 'none', cursor: 'pointer', fontSize: 12, color: 'var(--text-disabled)',
        ...
        {deleteTarget && (
          ...
          >
            <div
              onClick={(e) => e.stopPropagation()}
              style={{
                background: 'var(--bg-white)', borderRadius: 18, padding: '28px 28px 20px',
            ...
            >
              ...
              <p style={{ fontSize: 14, color: 'var(--text-muted)', lineHeight: 1.6, margin: '0 0 20px' }}>
                Are you sure you want to permanently delete <strong style={{ color: 'var(--text-primary)' }}>{deleteTarget.name}</strong>?
              ...
              <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: deleting ? '#fca5a5' : '#ef4444', color: 'var(--bg-white)',
