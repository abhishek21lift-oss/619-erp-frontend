    ...
    return (
      <AppShell>
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/30 to-white flex items-center justify-center">
          <div className="animate-pulse text-[var(--text-muted)] text-[13px] font-medium">Loading payment details...</div>
        </div>
      </AppShell>
    );
  }
        ...
        <div className="mx-auto max-w-[1000px] px-4 py-6 sm:px-6 sm:py-8 space-y-6">
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div className="flex items-center gap-3">
              <button
                onClick={() => router.back()}
                className="flex h-9 w-9 items-center justify-center rounded-xl bg-white border border-[rgba(0,0,0,0.04)] text-[var(--text-muted)] hover:bg-[#F5F5F7] transition-colors"
              >
                <ArrowLeft size={16} strokeWidth={1.8} />
              </button>
              <div>
                <h1 className="text-[20px] sm:text-[24px] font-bold tracking-[-0.025em] text-[var(--text-primary)] leading-tight">
                  Payments Details
                </h1>
                <p className="text-[12px] text-[var(--text-muted)] mt-0.5">Membership billing & receipt management</p>
              </div>
            </div>
            <button
          ...
          <div className="rounded-[24px] bg-white/70 backdrop-blur-[20px] border border-white/25 shadow-[0_8px_32px_rgba(11,11,15,0.06)] p-5 space-y-3">
            <div className="flex flex-wrap gap-2">
              ...
              <button className="inline-flex items-center gap-2 rounded-xl bg-white border border-[rgba(0,0,0,0.04)] px-4 py-2 text-[12px] font-bold text-[var(--text-muted)] hover:bg-[#F5F5F7] transition-colors">
          ...
          <div className="rounded-[24px] bg-white/70 backdrop-blur-[20px] border border-white/25 shadow-[0_8px_32px_rgba(11,11,15,0.06)] p-6">
            <div className="flex flex-col items-center text-center mb-6">
              ...
              <h2 className="text-[20px] font-bold text-[var(--text-primary)]">{memberName}</h2>
              <div className="flex items-center gap-2 mt-2">
                <Phone size={13} className="text-[var(--text-muted)]" strokeWidth={1.5} />
                <span className="text-[13px] text-[var(--text-muted)]">{memberMobile}</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  className="w-full h-10 rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] px-3.5 text-[13px] text-[var(--text-primary)] outline-none focus:border-[rgba(59,130,246,0.3)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(59,130,246,0.06)] transition-all placeholder:text-[#86868b]/60"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    type="date"
                    className="w-full h-10 rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] px-3.5 text-[13px] text-[var(--text-primary)] outline-none focus:border-[rgba(59,130,246,0.3)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(59,130,246,0.06)] transition-all"
                    value={dob}
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  className="w-full min-h-[72px] rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] px-3.5 py-2.5 text-[13px] text-[var(--text-primary)] outline-none focus:border-[rgba(59,130,246,0.3)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(59,130,246,0.06)] transition-all placeholder:text-[#86868b]/60 resize-none"
          ...
          <div className="rounded-[24px] bg-white/70 backdrop-blur-[20px] border border-white/25 shadow-[0_8px_32px_rgba(11,11,15,0.06)] p-6">
            <h3 className="text-[14px] font-bold text-[var(--text-primary)] mb-4">Tax & Billing Representative</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-[11px] font-semibold text-[var(--text-muted)] mb-2 uppercase tracking-[0.04em]">IGST Bill</label>
                <div className="flex gap-3">
                  {['yes', 'no'].map(opt => (
                    <label key={opt} className="flex items-center gap-2 cursor-pointer">
                      ...
                      />
                      <span className="text-[12px] font-medium text-[var(--text-primary)] capitalize">{opt}</span>
                    </label>
                  ))}
                </div>
              </div>
              <div className="space-y-1.5">
                <p className="flex justify-between text-[12px]"><span className="text-[var(--text-muted)]">Client Rep</span><span className="font-semibold text-[var(--text-primary)]">619 Fitness Studio</span></p>
                <p className="flex justify-between text-[12px]"><span className="text-[var(--text-muted)]">Bill Rep</span><span className="font-semibold text-[var(--text-primary)]">619 Fitness Studio (2325614)</span></p>
                <p className="flex justify-between text-[12px]"><span className="text-[var(--text-muted)]">Membership Added By</span><span className="font-semibold text-[var(--text-primary)]">—</span></p>
              </div>
              <div>
                <label className="block text-[11px] font-semibold text-[var(--text-muted)] mb-1.5 uppercase tracking-[0.04em]">Bill Rep *</label>
                <select
                  className="w-full h-10 rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] px-3.5 text-[13px] text-[var(--text-primary)] outline-none focus:border-[rgba(59,130,246,0.3)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(59,130,246,0.06)] transition-all"
                  value={billRep}
              ...
              <div>
                <label className="block text-[11px] font-semibold text-[var(--text-muted)] mb-1.5 uppercase tracking-[0.04em]">Invoice Date</label>
                <input
                  type="date"
                  className="w-full h-10 rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] px-3.5 text-[13px] text-[var(--text-primary)] outline-none focus:border-[rgba(59,130,246,0.3)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(59,130,246,0.06)] transition-all"
                  value={invoiceDate}
          ...
          <div className="rounded-[24px] bg-white/70 backdrop-blur-[20px] border border-white/25 shadow-[0_8px_32px_rgba(11,11,15,0.06)] overflow-hidden">
            <div className="p-5 pb-0">
              <h3 className="text-[14px] font-bold text-[var(--text-primary)]">Membership Billing Summary</h3>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full text-[12px]">
                <thead>
                  <tr className="border-b border-[rgba(0,0,0,0.04)]">
                    <th className="text-left py-3 px-5 font-semibold text-[var(--text-muted)]">#</th>
                    <th className="text-left py-3 px-5 font-semibold text-[var(--text-muted)]">Membership Plan</th>
                    <th className="text-left py-3 px-5 font-semibold text-[var(--text-muted)]">Start Date</th>
                    <th className="text-left py-3 px-5 font-semibold text-[var(--text-muted)]">End Date</th>
                    <th className="text-right py-3 px-5 font-semibold text-[var(--text-muted)]">Plan Price</th>
                    <th className="text-right py-3 px-5 font-semibold text-[var(--text-muted)]">Discount</th>
                    <th className="text-right py-3 px-5 font-semibold text-[var(--text-muted)]">Net Amount</th>
                  </tr>
                </thead>
                <tbody>
                  {planRows.map((row: any, i: number) => {
                    ...
                    return (
                      <tr key={i} className="border-b border-[rgba(0,0,0,0.03)] last:border-0">
                        <td className="py-3 px-5 text-[var(--text-muted)]">{i + 1}</td>
                        <td className="py-3 px-5 font-medium text-[var(--text-primary)]">{row.plan || '—'}</td>
                        <td className="py-3 px-5 text-[var(--text-muted)]">{row.startDate || '—'}</td>
                        <td className="py-3 px-5 text-[var(--text-muted)]">{row.endDate || '—'}</td>
                        <td className="py-3 px-5 text-right text-[var(--text-primary)] font-medium">{fmt(mrp)}</td>
                        <td className="py-3 px-5 text-right text-[#EF4444]">{disc > 0 ? `-${fmt(disc)}` : '—'}</td>
                        <td className="py-3 px-5 text-right font-bold text-[var(--text-primary)]">{fmt(net)}</td>
                      </tr>
                    );
                  })}
                </tbody>
                <tfoot>
                  <tr className="border-t border-[rgba(0,0,0,0.06)] bg-[rgba(59,130,246,0.03)]">
                    <td colSpan={4} className="py-3.5 px-5 font-bold text-[var(--text-primary)]">Total</td>
                    <td className="py-3.5 px-5 text-right font-bold text-[var(--text-primary)]">{fmt(totalMrp)}</td>
                    <td className="py-3.5 px-5 text-right font-bold text-[#EF4444]">{totalDiscount > 0 ? `-${fmt(totalDiscount)}` : '—'}</td>
                    <td className="py-3.5 px-5 text-right font-bold text-[var(--text-primary)]">{fmt(totalNet)}</td>
                  </tr>
                  <tr className="bg-[rgba(16,185,129,0.03)]">
                    <td colSpan={5} className="py-3 px-5 font-semibold text-[var(--text-primary)]">Sale Amount</td>
                    <td colSpan={2} className="py-3 px-5 text-right font-bold text-[var(--text-primary)]">{fmt(totalNet)}</td>
                  </tr>
                  <tr className="bg-[rgba(59,130,246,0.03)]">
                    <td colSpan={5} className="py-3 px-5 font-semibold text-[var(--text-primary)]">Paid Amount</td>
                  ...
                  <tr className="bg-[rgba(239,68,68,0.03)]">
                    <td colSpan={5} className="py-3 px-5 font-semibold text-[var(--text-primary)]">Balance Amount</td>
                  ...
                  <tr className="bg-[rgba(245,158,11,0.03)]">
                    <td colSpan={5} className="py-3 px-5 font-semibold text-[var(--text-primary)]">Payment Status</td>
          ...
          {/* ── Receipts Section ── */}
          <div className="rounded-[24px] bg-white/70 backdrop-blur-[20px] border border-white/25 shadow-[0_8px_32px_rgba(11,11,15,0.06)] p-6">
            <h3 className="text-[14px] font-bold text-[var(--text-primary)] mb-4">Receipts</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <div>
                <label className="block text-[11px] font-semibold text-[var(--text-muted)] mb-1.5 uppercase tracking-[0.04em]">Membership Plan</label>
                <select
                  className="w-full h-10 rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] px-3.5 text-[13px] text-[var(--text-primary)] outline-none focus:border-[rgba(59,130,246,0.3)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(59,130,246,0.06)] transition-all"
                  value={receiptPlan}
              ...
              <div>
                <label className="block text-[11px] font-semibold text-[var(--text-muted)] mb-1.5 uppercase tracking-[0.04em]">Receipt Number</label>
                <input
                  className="w-full h-10 rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] px-3.5 text-[13px] text-[var(--text-primary)] outline-none focus:border-[rgba(59,130,246,0.3)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(59,130,246,0.06)] transition-all placeholder:text-[#86868b]/60"
              ...
              <div>
                <label className="block text-[11px] font-semibold text-[var(--text-muted)] mb-1.5 uppercase tracking-[0.04em]">Received Amount</label>
                <input
                  type="number"
                  step="0.01"
                  className="w-full h-10 rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] px-3.5 text-[13px] text-[var(--text-primary)] outline-none focus:border-[rgba(59,130,246,0.3)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(59,130,246,0.06)] transition-all"
              ...
              <div>
                <label className="block text-[11px] font-semibold text-[var(--text-muted)] mb-1.5 uppercase tracking-[0.04em]">Receipt Date</label>
                <input
                  type="date"
                  className="w-full h-10 rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] px-3.5 text-[13px] text-[var(--text-primary)] outline-none focus:border-[rgba(59,130,246,0.3)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(59,130,246,0.06)] transition-all"
                  value={receiptDate}
              ...
              <div>
                <label className="block text-[11px] font-semibold text-[var(--text-muted)] mb-1.5 uppercase tracking-[0.04em]">Payment Method</label>
                <select
                  className="w-full h-10 rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] px-3.5 text-[13px] text-[var(--text-primary)] outline-none focus:border-[rgba(59,130,246,0.3)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(59,130,246,0.06)] transition-all"
                  value={paymentMethod}
              ...
              <div>
                <label className="block text-[11px] font-semibold text-[var(--text-muted)] mb-1.5 uppercase tracking-[0.04em]">Payment Status</label>
                <select
                  className="w-full h-10 rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] px-3.5 text-[13px] text-[var(--text-primary)] outline-none focus:border-[rgba(59,130,246,0.3)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(59,130,246,0.06)] transition-all"
                  value={paymentStatus}
              ...
              <div className="sm:col-span-2 lg:col-span-3">
                <label className="block text-[11px] font-semibold text-[var(--text-muted)] mb-1.5 uppercase tracking-[0.04em]">Notes</label>
                <input
                  className="w-full h-10 rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] px-3.5 text-[13px] text-[var(--text-primary)] outline-none focus:border-[rgba(59,130,246,0.3)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(59,130,246,0.06)] transition-all placeholder:text-[#86868b]/60"
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 mt-5 pt-5 border-t border-[rgba(0,0,0,0.04)]">
              <div className="text-[11px] text-[var(--text-muted)]">
                Receipt Added By: <span className="font-semibold text-[var(--text-primary)]">619 Fitness Studio</span>
