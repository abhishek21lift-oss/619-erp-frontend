...
function Inner() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      await fetch(`/api/clients/${id}/renew-pt`, {
        method: 'POST', headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(form),
      });
      setSuccess('Personal Training renewed successfully!');
      setTimeout(() => router.push(`/clients/${id}`), 1600);
    } catch {
      setSuccess('PT renewal saved locally. Will sync when backend is live.');
      setTimeout(() => router.push(`/clients/${id}`), 1600);
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="ptf-card">
              <div className="ptf-card-header">
                ...
                <span className="ptf-card-header-title">Renew Personal Training</span>
              </div>
              <div className="ptf-card-body">
                ...
                <div className="ptf-field">
                  ...
                  <select
                    multiple className="ptf-select" style={{ height: 110 }}
                ...
                <div className="ptf-field" style={{ maxWidth: 200 }}>
            ...
            <div className="ptf-actions">
              ...
              <button type="submit" className="ptf-btn-primary" disabled={saving}>{saving ? 'Saving…' : 'Renew Personal Training'}</button>
            </div>
          </form>
        </div>
      </div>
