      ...
      <AppShell>
        <div className="min-h-screen bg-gradient-to-br from-[#F5F5F7] via-indigo-50/30 to-white flex items-center justify-center">
          <div className="flex flex-col items-center gap-3">
            ...
            <span className="text-[13px] font-medium text-[#4A4E57]">Loading assignment form...</span>
          </div>
        </div>
      </AppShell>
    );
    ...
    <AppShell>
      ...
      >
                ...
                >
                  ...
                  >
                    <Icon
                      size={18}
                      strokeWidth={1.5}
                      className={selected ? 'text-white' : 'text-[#4A4E57]'}
                    />
                  </div>
                  <div>
                    <p
                    ...
                    <p className="text-[18px] font-extrabold mt-0.5 tracking-tight text-[#0B0B0F]">
                      ₹{p.final.toLocaleString('en-IN')}
                    </p>
                    <p className="text-[10px] text-[#4A4E57] mt-0.5 font-medium">
                      {p.sessions} sessions
                    </p>
                  </div>
                </button>
        ...
        <GlassCard>
              ...
              return (
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-[10px] text-[#4A4E57] mt-0.5">
          ...
          <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <select
                multiple
                className="w-full h-[90px] rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] px-3 py-2 text-[13px] text-[#0B0B0F] outline-none focus:border-[rgba(139,92,246,0.3)] focus:bg-white transition-all"
            ...
            <div>
              ...
              <input
                type="number"
                placeholder="0"
                className="w-full h-11 rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] px-3.5 text-[14px] text-[#0B0B0F] outline-none focus:border-[rgba(139,92,246,0.3)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(139,92,246,0.06)] transition-all"
        ...
        <GlassCard>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <div className="relative">
                <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[13px] font-semibold text-[#4A4E57]">₹</span>
                <input
                  type="number"
                  placeholder="0"
                  className="w-full h-11 rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] pl-8 pr-3.5 text-[14px] text-[#0B0B0F] outline-none focus:border-[rgba(16,185,129,0.3)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(16,185,129,0.06)] transition-all"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  step="0.01"
                  placeholder="0"
                  className="w-full h-11 rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] pl-8 pr-3.5 text-[14px] text-[#0B0B0F] outline-none focus:border-[rgba(245,158,11,0.3)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(245,158,11,0.06)] transition-all"
            ...
            <div className="sm:col-span-2">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 h-11 rounded-xl border border-[rgba(0,0,0,0.04)] bg-[#F5F5F7] px-3.5 text-[14px] text-[#0B0B0F] outline-none focus:border-[rgba(139,92,246,0.3)] focus:bg-white focus:shadow-[0_0_0_3px_rgba(139,92,246,0.06)] transition-all uppercase tracking-[0.08em]"
                  value={form.coupon}
          ...
          {/* Payment Method */}
          <div className="mt-5">
            <p className="text-[11px] font-semibold text-[#4A4E57] mb-2.5 uppercase tracking-[0.04em]">
              <Wallet size={12} className="inline mr-1" />
              Payment Method
            </p>
