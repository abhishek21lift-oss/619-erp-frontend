...
// Error boundary for /member (audit H-02).
//
// Without this, a throw anywhere under /member propagated to src/app/error.tsx
...
export default function MemberError(
  ...
  return <RouteError {...props} shell={true} segment="member" />;
}
